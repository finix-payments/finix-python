...
class ApplicationProfilesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self._get_endpoint = finix.api_client.Endpoint(
            settings={
                'response_type': (ApplicationProfile,),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/application_profiles/{application_profile_id}',
                'operation_id': 'get',
                'http_method': 'GET',
                'servers': None,
            },
        ...
        self._list_endpoint = finix.api_client.Endpoint(
            settings={
                'response_type': (ApplicationProfilesList,),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/application_profiles',
                'operation_id': 'list',
                'http_method': 'GET',
                'servers': None,
            },
        ...
        self._update_endpoint = finix.api_client.Endpoint(
            ...
            params_map={
                'all': [
                    'application_profile_id',
                    'update_application_profile_request',
                ],
                'required': [
                    'application_profile_id',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'application_profile_id': 'path',
                    'update_application_profile_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get(
        ...
        **kwargs
        ...
        """Get Application Profile  # noqa: E501

        Find an existing `application_profile` by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get(application_profile_id, async_req=True)
        >>> result = thread.get()

        Args:
            application_profile_id (str): ID of application profile to use
    ...
    def list(
        ...
        **kwargs
        ...
        """List Application Profiles  # noqa: E501

        Return a collection of `application_profiles`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update(
        ...
        **kwargs
        ...
        """Update Application Profile  # noqa: E501

        Update an existing `application_profile`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update(application_profile_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            update_application_profile_request (UpdateApplicationProfileRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
