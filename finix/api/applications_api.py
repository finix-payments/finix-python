...
class ApplicationsApi(object):
    ...
    def create(
        ...
        **kwargs
        ...
        If created successfully, returns a 201 status and adds a location header to the response which refers to the new created `Application`.   # noqa: E501
    ...
    def get(
        ...
        **kwargs
        ...
        """Fetch an Application  # noqa: E501

        Retrieve the details of an `Application`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get(application_id, async_req=True)
        >>> result = thread.get()
    ...
    def list(
        ...
        **kwargs
        ...
        Return a collection of `Applications`. If there are no `Applications`, an empty collection will be returned.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update(
        ...
        **kwargs
        ...
        >>> thread = api.update(application_id, async_req=True)
        >>> result = thread.get()
