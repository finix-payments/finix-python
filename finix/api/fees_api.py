...
class FeesApi(object):
    ...
    def create(
        ...
        **kwargs
        ...
        """Create a One-Time Fee  # noqa: E501

        Create a custom (i.e. one time) `fee`.  # noqa: E501
        ...
        Keyword Args:
            create_fee_request (CreateFeeRequest): [optional]
    ...
    def get(
        ...
        **kwargs
        ...
        Retrieve the details of a `Fee`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get(fee_id, async_req=True)
        >>> result = thread.get()

        Args:
            fee_id (str): ID of fee to use
    ...
    def list(
        ...
        **kwargs
        ...
        Return a collection of `fees`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update(
        ...
        **kwargs
        ...
        """Update Fee  # noqa: E501

        Update the details of a `Fee`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update(fee_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            update_fee_request (UpdateFeeRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
