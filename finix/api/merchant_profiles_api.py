...
class MerchantProfilesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self._get_endpoint = finix.api_client.Endpoint(
            settings={
                'response_type': (MerchantProfile,),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/merchant_profiles/{merchant_profile_id}',
                'operation_id': 'get',
                'http_method': 'GET',
                'servers': None,
            },
        ...
        self._list_endpoint = finix.api_client.Endpoint(
            settings={
                'response_type': (MerchantProfilesList,),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/merchant_profiles',
                'operation_id': 'list',
                'http_method': 'GET',
                'servers': None,
            },
    ...
    def get(
        ...
        **kwargs
        ...
        >>> thread = api.get(merchant_profile_id, async_req=True)
        >>> result = thread.get()
    ...
    def update(
        ...
        **kwargs
        ...
        >>> thread = api.update(merchant_profile_id, async_req=True)
        >>> result = thread.get()
