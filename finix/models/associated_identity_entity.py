...
class AssociatedIdentityEntity(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AssociatedIdentityEntity - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            business_name (str): The merchant's legal business name (max 120 characters).<ul><li>If <strong>INDIVIDUAL_SOLE_PROPRIETORSHIP</strong>, pass the owner's legal first name, last name and middle initial.. [optional]  # noqa: E501
            ...
            tax_authority (str): <ul><li>Only required when onboarding a merchant with a <tt>MCC</tt> of <strong>9311</strong>.<li> The <tt>tax_authority</tt> is the tax gathering entity (e.g San Francisco Water Authority).. [optional]  # noqa: E501
