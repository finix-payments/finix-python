...
from finix.exceptions import ApiTypeError, ApiValueError, ApiException
from finix.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class FinixClient(object):
    ...
    def deserialize(self, response, response_type, _check_type):
        ...
        if response_type == (file_type,):
            ...
            return deserialize_file(response.data, self._configuration,
    ...
    def request(self, method, url, query_params=None, headers=None,
        ...
        if method == "GET":
            ...
            return self._rest_client.HEAD(url,
                                         query_params=query_params,
                                         _preload_content=_preload_content,
                                         _request_timeout=_request_timeout,
                                         headers=headers)
        elif method == "OPTIONS":
            return self._rest_client.OPTIONS(url,
                                            query_params=query_params,
                                            headers=headers,
            ...
            return self._rest_client.PUT(url,
                                        query_params=query_params,
                                        headers=headers,
                                        post_params=post_params,
                                        _preload_content=_preload_content,
            ...
            return self._rest_client.PATCH(url,
                                          query_params=query_params,
                                          headers=headers,
                                          post_params=post_params,
                                          _preload_content=_preload_content,
            ...
            return self._rest_client.DELETE(url,
                                           query_params=query_params,
                                           headers=headers,
                                           _preload_content=_preload_content,
                                           _request_timeout=_request_timeout,
    ...
    def update_params_for_auth(self, headers, queries, auth_settings,
        ...
        for auth in auth_settings:
            auth_setting = self._configuration.auth_settings().get(auth)
            if auth_setting:
...
class Endpoint(object):
        ...
        for param in self.params_map['validation']:
            if param in kwargs:
                check_validations(
                    ...
                    (param,),
                    kwargs[param],
                    configuration=self.api_client._configuration
                )
    ...
    def __gather_params(self, kwargs):
        ...
        for param_name, param_value in kwargs.items():
            ...
            if param_location is None:
                while param_name not in {"async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_check_input_type", "_check_return_type", "_spec_property_naming", "_content_type", "_host_index"}:
                    param_value_full = (param_name, param_value)
    ...
    def call_with_http_info(self, **kwargs):
        ...
        try:
            index = self.api_client._configuration.server_operation_index.get(
                self.settings['operation_id'], self.api_client._configuration.server_index
            ) if kwargs['_host_index'] is None else kwargs['_host_index']
            server_variables = self.api_client._configuration.server_operation_variables.get(
                self.settings['operation_id'], self.api_client._configuration.server_variables
            )
            _host = self.api_client._configuration.get_host_from_settings(
