...
conf = finix.Configuration(
    ...
    def __init__(self, environment=None,
        ...
        """Constructor
        """
        self._base_path = "https://finix.sandbox-payments-api.com" if environment is None else environment
        """Default Base url
        """
        self.server_index = 0 if server_index is None and environment is None else server_index
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("finix")
