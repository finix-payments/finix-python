...
class RiskProfileRule(ModelNormal):
    """
    ...
    validations = {
        ('id',): {
            'regex': {
                'pattern': r'^(RR)[a-zA-Z0-9]{16,32}$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'trailing': (int,),  # noqa: E501
            'trailing_unit': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'trailing': 'trailing',  # noqa: E501
        'trailing_unit': 'trailing_unit',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RiskProfileRule - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            trailing (int): [optional]  # noqa: E501
            trailing_unit (str): [optional]  # noqa: E501
